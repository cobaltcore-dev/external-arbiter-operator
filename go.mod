...
require (
	...
	github.com/rook/rook/pkg/apis v0.0.0-20251110151448-532ea8d497a7
	k8s.io/api v0.34.1
...
require (
	...
	sigs.k8s.io/controller-runtime/tools/setup-envtest v0.0.0-20251110071253-a6adaac19017 // indirect
